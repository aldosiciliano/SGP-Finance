...
const Dashboard = () => {
  const { error, expenseCategories, isLoading, monthlyExpenseSeries, recentExpenses, stats, reload } =
    useDashboardData();
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-3">
                          <p className="min-w-0 flex-1 truncate text-sm font-semibold leading-tight text-[var(--text)]">
                            {category.name}
                          </p>
